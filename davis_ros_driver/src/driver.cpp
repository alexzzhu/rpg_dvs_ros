...
void DavisRosDriver::caerConnect()
{
  ...
  ROS_INFO("%s --- ID: %d, Master: %d, DVS X: %d, DVS Y: %d, Logic: %d.\n",
           ...
           davis_info_.deviceID,
           davis_info_.deviceIsMaster,
           davis_info_.dvsSizeX,
           davis_info_.dvsSizeY,
  ...
  if (davis_info_.chipID == DAVIS_CHIP_DAVIS346B)
  {
    caerDeviceConfigSet(davis_handle_,
                        DAVIS_CONFIG_APS,
                        DAVIS_CONFIG_APS_END_COLUMN_0,
                        U16T(davis_info_.apsSizeX-1));
    caerDeviceConfigSet(davis_handle_,
                        DAVIS_CONFIG_APS,
                        DAVIS_CONFIG_APS_END_ROW_0,
                        U16T(davis_info_.apsSizeY-1));
  }
  ...
  while(running_)
  {
    try
    {
      ...
      if (davis_info_.chipID == DAVIS_CHIP_DAVIS346B)
      {
        ...
        //caerBiasCoarseFineGenerate(CF_N_TYPE(3, 39)));
        ...
        //caerBiasCoarseFineGenerate(CF_N_TYPE(2, 255)));
        ...
        //caerBiasCoarseFineGenerate(CF_N_TYPE(3, 0)));
        ...
        //caerBiasCoarseFineGenerate(CF_P_TYPE(5, 58)));
        ...
        //caerBiasCoarseFineGenerate(CF_P_TYPE(6, 16)));
        ...
        //caerBiasCoarseFineGenerate(CF_P_TYPE(3, 25)));
